...
@RestController
//eliminate the need to annotate every request handling method
...
public class CollegeController {
	...
	public void add(@RequestBody College College) {//annotation maps the HttpRequest body to a transfer or domain object
